...
function showResult() {
  ...
  if (score > 3) {
    let scoreTag = `<span>Selamat! score anda benar ` + score + ` dari ` + questions.length + ` 🔥</span>`;
    scoreText.innerHTML = scoreTag;
  } else if (score > 1) {
    let scoreTag = `<span>Nice! score anda benar ` + score + ` dari ` + questions.length + ` 🔥</span>`;
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag = `<span>Sorry! score anda benar ` + score + ` dari ` + questions.length + ` 🔥</span>`;
    scoreText.innerHTML = scoreTag;
  }
}
